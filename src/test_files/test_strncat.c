...
START_TEST(strncat_1) {
  char s1[30] = "Test, Phrase hello";
  char s2[30] = "Test, Phrase hello";
  char s3[] = "Test, Phrase hello";
  s21_size_t n = 1;
...
START_TEST(strncat_6) {
  char s1[100] = "Test, Phrase hello";
  char s2[100] = "Test, Phrase hello";
  char s3[] = "lhk1c432llhkjsfdahkljfdajlfdsa";
  s21_size_t n = 6;
  ck_assert_pstr_eq(strncat(s1, s3, n), s21_strncat(s2, s3, n));
}
END_TEST
...
START_TEST(strncat_10) {
  ...
  char s3[] = "h2l134kj\0jasfhkjldsahk";
  s21_size_t n = 15;
  ck_assert_pstr_eq(strncat(s1, s3, n), s21_strncat(s2, s3, n));
}
END_TEST
...
START_TEST(strncat_15) {
  char s1[100] = "Test, Phrase hello\0\0\0";
  char s2[100] = "Test, Phrase hello\0\0\0";
  char s3[] = "Mlhkjqrlkjj23hkjh4q";
  s21_size_t n = 0;
  ck_assert_pstr_eq(strncat(s1, s3, n), s21_strncat(s2, s3, n));
}
END_TEST
