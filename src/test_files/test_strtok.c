...
START_TEST(strtok_1) {
  char s1[] = "HTest, Phrase!";
  char s2[] = "HTest, Phrase!";
  char s3[] = "!";
...
START_TEST(strtok_6) {
  char s1[] = "HTest, Phrase!";
  char s2[] = "HTest, Phrase!";
  char s3[] = "lj23lkjdsfa;lkdfsaaf;lkds;lksfda";
  ck_assert_pstr_eq(strtok(s1, s3), s21_strtok(s2, s3));
}
END_TEST
...
START_TEST(strtok_9) {
  char s1[] = "\0HTest, Phrase!";
  char s2[] = "\0HTest, Phrase!";
  char s3[] = "\0";
  ck_assert_pstr_eq(strtok(s1, s3), s21_strtok(s2, s3));
}
END_TEST
...
START_TEST(strtok_13) {
  char s1[] = "Test, Phrase! dsfg";
  char s2[] = "Test, Phrase! dsfg";
  char s3[] = "\0test";
  char s4[] = "\0test";
  char s5[] = "";
...
START_TEST(strtok_14) {
  char s1[] = "Test, PHRASE ;a;flsafkjsa";
  char s2[] = "Test, PHRASE ;a;flsafkjsa";
  char s5[] = " H";
  ck_assert_pstr_eq(strtok(s1, s5), s21_strtok(s2, s5));
  for (int i = 0; i < 5; i++) {
    ck_assert_pstr_eq(strtok(S21_NULL, s5), s21_strtok(S21_NULL, s5));
...
START_TEST(strtok_15) {
  char s1[] = "Hello,      aj;kslfdw;lkqjelj;wejl;keqrwlllllllfdagsfg      ";
  char s2[] = "Hello,      aj;kslfdw;lkqjelj;wejl;keqrwlllllllfdagsfg      ";
  char s3[] = "TestTest";
  char s4[] = "TestTest";
  char s5[] = " l";
...
START_TEST(strtok_16) {
  char s1[] = "i allrewjhlksajfhjasfhs;f ;wa   ;afha;wh;efhuw      ";
  char s2[] = "i allrewjhlksajfhjasfhs;f ;wa   ;afha;wh;efhuw      ";
  char s3[] = "hellotesttest";
  char s4[] = "hellotesttest";
  char s5[] = "l";
  char s6[] = " ";
