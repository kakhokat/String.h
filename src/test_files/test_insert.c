...
START_TEST(test_insert_1) {
  char s1[30] = "im testing!";
  char s3[] = "BROO jas;flkk ajflwe:JHF:EHK!";
  char s4[] = "im testBROO jas;flkk ajflwe:JHF:EHK!ing!";
  s21_size_t num = 7;
...
START_TEST(test_insert_4) {
  ...
  char s3[] = "\'ioiq4iufaipo\'";
  char s4[] = "abc\'ioiq4iufaipo\'defghij";
  s21_size_t num = 3;
  char *s2 = s21_insert(s1, s3, num);
  ck_assert_pstr_eq(s4, s2);
  if (s2) free(s2);
...
START_TEST(test_insert_6) {
  char s1[30] = "im testing!";
  char s3[] = "BROO wtf ajflwe:JHF:EHK!";
  char *s4 = S21_NULL;
  s21_size_t num = -1;
  char *s2 = s21_insert(s1, s3, num);
  ck_assert_pstr_eq(s4, s2);
